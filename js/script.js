	...
	if($.isFunction($.fn.countdown))
	{
		$('.countdown[data-date]').countdown(
		{
			...
			render: function(data)
			{
				$(this.el).html
				(
					"<div class=\"countdown-box\"><h2 class=\"countdown-number\">" + data.days + "</h2>" + " <h4 class=\"countdown-title\">Day</h4></div>" +
					"<div class=\"countdown-box\"><h2 class=\"countdown-number\">" + data.hours + "</h2>" + " <h4 class=\"countdown-title\">Hour</h4></div>" +
					"<div class=\"countdown-box\"><h2 class=\"countdown-number\">" + this.leadingZeros(data.min, 2) + "</h2>" + " <h4 class=\"countdown-title\">Minute</h4></div>" +
					"<div class=\"countdown-box\"><h2 class=\"countdown-number\">" + this.leadingZeros(data.sec, 2) + "</h2>" + " <h4 class=\"countdown-title\">Second</h4></div>"
				);
			}
		});
	}
